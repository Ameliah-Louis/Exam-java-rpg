...
public class Gobelin extends Ennemi {
    ...
    public Gobelin() {
        ...
        super("Gobelin", 50, 10, 5);  // PV=50, Attaque=10, Défense=5 (exemple)
    }
    ...
    protected void attaque1(Personnage cible) {
        ...
        System.out.println(getNom() + " frappe " + cible.getNom() + " !");
    ...
    protected void attaque2(Personnage cible) {
        ...
        if (degats < 0) degats = 0;
        System.out.println(getNom() + " lance un coup puissant en hurlant sur " + cible.getNom() + " !");
        cible.prendreDegats(degats);
    }
}
